...
- "Power Editing with Vi: Basics"
  - A hands-on workshop based on Bill Joy's [An Introduction to Display Editing with Vi](/pdfs/An_Introduction_to_Display_Editing_with_Vi.pdf), the original paper introducing the Vi editor and all its features: core and advanced. I put together two workshops, covering all the features, and in the same sequence in which the author presented them. This is part one, covering the core features.
